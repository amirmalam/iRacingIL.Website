...
using System;
using System.IO;
using iRacingIL.Website.Data;

namespace iRacingIL.Website
{
        ...
        public static void Main(string[] args)
        {
            var host = new WebHostBuilder()
                ...
                .ConfigureServices(services =>
                {
                    ...
                    //services.AddDbContext<iRacingILContext>(options =>
                    //    options.usem(Configuration.GetConnectionString("DefaultConnection")));
                })
